...
public class BloomGuavaTest {
    static final Logger _LOG = LoggerFactory.getLogger(BloomGuavaTest.class);
    ...
    public void testLoadBloom() throws Exception {
        ...
        BloomGuava bloomGuava = new BloomGuava(1000000000);
        bloomGuava.loadBloom(list.toArray(new String[list.size()]));
        ...
        Assert.assertNotNull(bloomGuava);
    }
}
